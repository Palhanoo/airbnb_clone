...
const DetailsPage = () => {
  ...
  // console.log("id", id)
  const listing: Listing = (listingsData as any[]).find((l) => l.id === id)
  ...
  const imageAnimatedStyle = useAnimatedStyle(() => {
    return {
      // transform: [{ translateY: scrollOffset.value / 2 }]
      transform: [
        {
      ...
      >
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.rooms}>
            {listing.guests_included} guests · {listing.bedrooms} bedroom · {listing.beds} bed · {listing.bathrooms} bath
          </Text>
